...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit", "gagkit", "zipties" };
...
/* System Settings */
    ...
    restricted_uniforms[] = { "U_Rangemaster", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_HeliPilotCoveralls", "U_B_survival_uniform" };
    ...
    fuelTank_winMultiplier = 1.25; //Win Multiplier in FuelTank Missions. Increase for greater payout. Default = 1
