...
/*									*/
	...
	hint format["Original Nickname: %1",_this select 1];
	[format["Your UUID is fixed another nickname, enter your old nickname in the profile of the game!<br/><br/>Original Nickname: <t color='#b20303'>%1</t><br/><br/>If you have any problems with the change nickname - refer to the Admins. TS: <t color='#665bff'>ftc.ts.nfoservers.com</t>",
	_this select 1],
